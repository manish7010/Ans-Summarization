...
Original file is located at
    https://colab.research.google.com/drive/1zbp_gpdsn6fa5VvcKW-DPUoT6lRWkcBA
"""
...
Train = open("drive/My Drive/Ranked-data/Train-cross-encoder.pickle","rb")
Train_data = pickle.load(Train)
Val = open("drive/My Drive/Ranked-data/Val-cross-encoder.pickle","rb")
Val_data = pickle.load(Val)
Test = open("drive/My Drive/Ranked-data/Test-cross-encoder.pickle","rb")
Test_data = pickle.load(Test)

train_data_txt = Dataset.from_list(Train_data)
val_data_txt = Dataset.from_list(Val_data)
test_data_txt = Dataset.from_list(Test_data)
